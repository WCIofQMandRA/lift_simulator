...
public:
    ...
    T& operator[](size_t pos)               {return m_elem[pos];}
    const T& operator[](size_t pos)const    {return m_elem[pos];}
...
private:
    ...
    inline void deallocate(T *p,size_t s)
    {
    ...
    void reset_capacity(size_t new_capacity)
    {
